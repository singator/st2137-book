...
the [following link](https://welcome.oda.sas.com/) should take you to this page:

![SAS Studio Login](figs/sas_welcome-01.png){#fig-sas-1 fig-alt="SAS login" fig-align="center" width=75%}

Subsequently logging in should take you to the landing page, where you can begin 
writing SAS code and using SAS:

![SAS Studio](figs/sas_welcome-02.png){#fig-sas-2 fig-alt="SAS Studio" fig-align="center" width=75%}
...
![SAS output](figs/sas_ex-1.png){#fig-sas-3 fig-alt="SAS output" fig-align="center" width=75%}
...
::: {layout-nrow=2}
![Dataset output](figs/sas_ex-2a.png){#fig-sas-4 fig-alt="DATA output" fig-align="center" width=70%}

![Proc output](figs/sas_ex-2b.png){#fig-sas-4 fig-alt="PROC output" fig-align="center" width=70%}
:::
...
section (see highligted tasks in @fig-sas-tasks-01).
...
the Group. You should observe the following plot created @fig-sas-bike-01:
