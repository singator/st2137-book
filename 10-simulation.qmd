...
claims are independent of each other and are distributed as $Exp(1/200)$[^1]
...
They will not be tested/covered in our exam.
...
intervals for estimators for which we may not have the know-how to derive analytic 
or asymptotic results.

Consider the confidence interval for the trimmed mean, that we encountered in topic 04.
